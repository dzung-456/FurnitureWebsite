...
export function Testimonials() {
  useEffect(() => {
    // Swiper sẽ được gắn vào class .testimonial-active-3
    // eslint-disable-next-line no-undef
    if (window.Swiper) {
      new window.Swiper(".testimonial-active-3", {
        loop: true,
        slidesPerView: 1,
        spaceBetween: 30,
        navigation: {
    ...
    >
      <div className="container">
        <div className="section-title-wrapper-4 is-white mb-40 text-center">
          <span className="section-subtitle-4 mb-10">Lời đánh giá</span>
          <h2 className="section-title-4">Phản hồi của khách hàng</h2>
        </div>
